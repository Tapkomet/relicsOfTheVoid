...
export default class FeatData extends ItemDataModel.mixin(
  ...
  /** @override */
  static LOCALIZATION_PREFIXES = ["ROTV.Enchantment", "ROTV.Prerequisites"];

  /** @inheritdoc */
  static defineSchema() {
    return this.mergeSchema(super.defineSchema(), {
      type: new ItemTypeField({baseItem: false}, {label: "ROTV.ItemFeatureType"}),
  ...
  static get compendiumBrowserFilters() {
    return new Map([
      ["category", {
        label: "ROTV.Item.Category.Label",
        type: "set",
        config: {
          choices: CONFIG.ROTV.featureTypes,
      ...
      ["subtype", {
        ...
        type: "set",
        config: {
          choices: Object.values(CONFIG.ROTV.featureTypes).reduce((obj, config) => {
  ...
  prepareDerivedData() {
    ...
    if ( this.type.value ) {
      const config = CONFIG.ROTV.featureTypes[this.type.value];
