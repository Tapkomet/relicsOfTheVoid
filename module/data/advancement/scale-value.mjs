  ...
  static defineSchema() {
    return {
      ...
      type: new foundry.data.fields.StringField({
        required: true, initial: "string", choices: TYPES, label: "ROTV.AdvancementScaleValueTypeLabel"
      }),
      distance: new foundry.data.fields.SchemaField({
        units: new foundry.data.fields.StringField({required: true, label: "ROTV.MovementUnits"})
      }),
...
export class ScaleValueType extends foundry.abstract.DataModel {
  ...
  static get metadata() {
    return {
      label: "ROTV.AdvancementScaleValueTypeString",
      hint: "ROTV.AdvancementScaleValueTypeHintString",
      isNumeric: false
    };
  }
...
export class ScaleValueTypeNumber extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "ROTV.AdvancementScaleValueTypeNumber",
      hint: "ROTV.AdvancementScaleValueTypeHintNumber",
      isNumeric: true
    });
  }
...
export class ScaleValueTypeCR extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "ROTV.AdvancementScaleValueTypeCR",
      hint: "ROTV.AdvancementScaleValueTypeHintCR"
    });
  }
...
export class ScaleValueTypeDice extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "ROTV.AdvancementScaleValueTypeDice",
      hint: "ROTV.AdvancementScaleValueTypeHintDice"
    });
  }
  ...
  get mods() {
    ...
    return this.modifiers.reduce((acc, mod) => {
      return acc + (rotv.utils.isValidDieModifier(mod) ? mod : "");
    }, "");
  }
...
export class ScaleValueTypeDistance extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "ROTV.AdvancementScaleValueTypeDistance",
      hint: "ROTV.AdvancementScaleValueTypeHintDistance"
    });
  }
