  ...
  static defineSchema() {
    return {
      items: new ArrayField(new SchemaField({
        ...
        optional: new BooleanField({label: "ROTV.AdvancementItemGrantOptional"})
      }), {required: true, label: "DOCUMENT.Items"}),
      optional: new BooleanField({
        required: true, label: "ROTV.AdvancementItemGrantOptional", hint: "ROTV.AdvancementItemGrantOptionalHint"
      }),
