  ...
  static defineSchema() {
    return {
      points: new foundry.data.fields.NumberField({
        ...
        label: "ROTV.AdvancementAbilityScoreImprovementPoints",
        hint: "ROTV.AdvancementAbilityScoreImprovementPointsHint"
      }),
      fixed: new MappingField(
        new foundry.data.fields.NumberField({nullable: false, integer: true, initial: 0}),
        {label: "ROTV.AdvancementAbilityScoreImprovementFixed"}
      ),
      cap: new foundry.data.fields.NumberField({
        integer: true, min: 1, initial: 2, label: "ROTV.AdvancementAbilityScoreImprovementCap",
        hint: "ROTV.AdvancementAbilityScoreImprovementCapHint"
      })
    };
  }
}
  ...
  static defineSchema() {
    return {
      ...
      feat: new MappingField(new foundry.data.fields.StringField(), {
        required: false, initial: undefined, label: "ROTV.Feature.Feat"
      })
    };
  }
}
