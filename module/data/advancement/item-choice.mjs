  ...
  static defineSchema() {
    return {
      choices: new MappingField(new SchemaField({
        ...
        replacement: new BooleanField({label: "ROTV.AdvancementItemChoiceReplacement"})
      }), {
        hint: "ROTV.AdvancementItemChoiceLevelsHint"
      }),
      allowDrops: new BooleanField({
        initial: true, label: "ROTV.AdvancementConfigureAllowDrops",
        hint: "ROTV.AdvancementConfigureAllowDropsHint"
      }),
      type: new StringField({
        blank: false, nullable: true, initial: null,
        label: "ROTV.AdvancementItemChoiceType", hint: "ROTV.AdvancementItemChoiceTypeHint"
      }),
      ...
      restriction: new SchemaField({
        type: new StringField({label: "ROTV.Type"}),
        subtype: new StringField({label: "ROTV.Subtype"}),
        level: new StringField({label: "ROTV.SpellLevel"})
      })
    };
  }
