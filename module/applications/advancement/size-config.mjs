...
export default class SizeConfig extends AdvancementConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["rotv", "advancement", "size"],
      template: "systems/rotv/templates/advancement/size-config.hbs"
    });
  }
  ...
  getData() {
    return foundry.utils.mergeObject(super.getData(), {
      ...
      sizes: Object.entries(CONFIG.ROTV.actorSizes).reduce((obj, [key, { label }]) => {
