...
export default class ItemChoiceConfig extends AdvancementConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["rotv", "advancement", "item-choice", "three-column"],
      dragDrop: [{ dropSelector: ".drop-target" }],
      dropKeyPath: "pool",
      template: "systems/rotv/templates/advancement/item-choice-config.hbs",
      width: 780
    });
  }
  ...
  getData(options={}) {
    ...
    const context = {
      ...
      abilities: Object.entries(CONFIG.ROTV.abilities).reduce((obj, [k, c]) => {
    ...
    if ( this.advancement.configuration.type === "feat" ) {
      const selectedType = CONFIG.ROTV.featureTypes[this.advancement.configuration.restriction.type];
      context.typeRestriction = {
        typeLabel: game.i18n.localize("ROTV.ItemFeatureType"),
        typeOptions: CONFIG.ROTV.featureTypes,
        subtypeLabel: game.i18n.format("ROTV.ItemFeatureSubtype", {category: selectedType?.label}),
