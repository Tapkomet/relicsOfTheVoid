 ...
 */
export default class ActorSheetRotVVehicle extends ActorSheetRotV {
  ...
  activateListeners(html) {
    ...
    html[0].querySelector('[data-tab="cargo"] rotv-inventory')
   ...
   * @returns {Promise<ActorRotV>|null}  Actor after update if any changes were made.
   * @private
   */
