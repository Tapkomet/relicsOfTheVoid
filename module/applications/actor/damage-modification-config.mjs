...
export default class DamageModificationConfig extends BaseConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["rotv", "damage-modification", "trait-selector", "subconfig"],
      template: "systems/rotv/templates/apps/damage-modification-config.hbs",
      width: 320,
      height: "auto"
    });
  }
  ...
  /** @inheritDoc */
  get title() {
    return game.i18n.localize("ROTV.DamageModification.Label");
  }
  ...
  async getData(options={}) {
    ...
    context.bypasses = Object.entries(CONFIG.ROTV.itemProperties).reduce((obj, [k, v]) => {
      if ( v.isPhysical ) obj[k] = { ...v, chosen: data.bypasses.has(k) };
      return obj;
    }, {});
    context.modifications = Object.entries(CONFIG.ROTV.damageTypes).reduce((obj, [k, v]) => {
      obj[k] = {
        ...v,
        value: data.amount[k]
      };
