 ...
 *
 * @param {ActorRotV} actor                     The Actor being configured.
...
export default class ProficiencyConfig extends BaseConfigSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["rotv"],
      template: "systems/rotv/templates/apps/proficiency-config.hbs",
      width: 500,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    const label = this.isSkill ? CONFIG.ROTV.skills[this.options.key].label
      : Trait.keyLabel(this.options.key, { trait: "tool" });
    return `${game.i18n.format("ROTV.ProficiencyConfigureTitle", {label})}: ${this.document.name}`;
  }
