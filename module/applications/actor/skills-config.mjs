...
export default class ActorSkillsConfig extends DialogMixin(DocumentSheet) {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["rotv2", "dialog", "skills-config"],
      template: "systems/rotv/templates/apps/skills-config.hbs",
      width: 500,
      height: "auto",
      sheetConfig: false,
      submitOnClose: true,
  ...
  getData(options={}) {
    ...
    for ( const [key, skill] of Object.entries(skills) ) {
      context.skills.push({
        key,
        label: CONFIG.ROTV.skills[key]?.label,
        value: source[key]?.value,
        total: skill.total,
        tooltip: CONFIG.ROTV.proficiencyLevels[skill.value]
      });
    }
