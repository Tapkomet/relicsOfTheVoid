 ...
 */
export default class JournalSheetRotV extends JournalSheet {
  /** @inheritDoc */
  static get defaultOptions() {
    const options = super.defaultOptions;
    options.classes.push("rotv2-journal");
    return options;
  }
  ...
  static onRenderJournalPageSheet(page, jQuery, context) {
    if ( page.object.parent.sheet instanceof JournalSheetRotV ) {
      let element;
      if ( context.editable ) element = jQuery[0];
      else element = jQuery[0].parentElement;
      element?.classList.add("rotv2-journal");
    }
  }
}
