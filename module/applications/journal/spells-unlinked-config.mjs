...
export default class SpellsUnlinkedConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["rotv", "unlinked-spell-config"],
      template: "systems/rotv/templates/journal/page-spell-list-unlinked-config.hbs",
      width: 400,
      height: "auto",
      sheetConfig: false
    });
  ...
  get title() {
    return `${game.i18n.localize(
      "JOURNALENTRYPAGE.ROTV.SpellList.UnlinkedSpells.Configuration")}: ${this.document.name}`;
  }
