...
export default class TraitSelector extends DocumentSheet {
  constructor(...args) {
    ...
    if ( !this.options.suppressWarning ) foundry.utils.logCompatibilityWarning(
      ...
      + "available at 'rotv.applications.actor.TraitSelector'. Support for the old application will "
      + "be removed in a future version.",
      { since: "RotV 2.1", until: "RotV 2.3" }
    );
  }
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      id: "trait-selector",
      classes: ["rotv", "trait-selector", "subconfig"],
