...
export default class CurrencyManager extends DialogMixin(FormApplication) {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["rotv2", "currency-manager", "dialog"],
      tabs: [{navSelector: "nav", contentSelector: ".sheet-content", initial: "transfer"}],
      template: "systems/rotv/templates/apps/currency-manager.hbs",
      title: "ROTV.CurrencyManager.Title",
      width: 350,
      height: "auto"
    });
  }
   ...
   * @param {ActorRotV|ItemRotV} doc  Actor or container item to convert.
   * @returns {Promise<ActorRotV|ItemRotV>}
   */
   ...
   * @param {ActorRotV|ItemRotV} origin       Document from which to move the currency.
