...
export default class CheckboxElement extends AdoptedStyleSheetMixin(
  ...
  static CSS = `
    ...
    :host > div {
      ...
      border: var(--checkbox-border-width, 2px) solid var(--checkbox-border-color, var(--rotv-color-gold));
    ...
    :host :is(.checked, .disabled, .indeterminate) {
      ...
      height: 100%;
      width: 100%;
      background: var(--checkbox-fill-color, var(--rotv-color-gold));
      align-items: center;
