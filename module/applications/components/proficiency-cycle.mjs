...
export default class ProficiencyCycleElement extends AdoptedStyleSheetMixin(HTMLElement) {
  ...
  static CSS = `
    ...
    div { --_fill: var(--proficiency-cycle-enabled-color, var(--rotv-color-blue)); }
    div:has(:disabled, :focus-visible) { --_fill: var(--proficiency-cycle-disabled-color, var(--rotv-color-gold)); }
  ...
  #refreshValue() {
    ...
    this.#internals.ariaValueText = CONFIG.ROTV.proficiencyLevels[this.#value];
