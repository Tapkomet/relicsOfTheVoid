 ...
 */
export default class TokenDocumentRotV extends SystemFlagsMixin(TokenDocument) {
   ...
   */
  get hasDynamicRing() {
    if ( game.release.generation < 12 ) return !!this.getFlag("rotv", "tokenRing.enabled");
  ...
  get subjectPath() {
    ...
    const subject = this.getFlag("rotv", "tokenRing")?.textures?.subject;
