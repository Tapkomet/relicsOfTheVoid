...
export default Base => class extends Base {
  ...
  static get documentConfig() {
    return CONFIG.ROTV[`${this.documentName.toLowerCase()}Types`];
  }
   ...
   * @param {ItemRotV} context.parent        A parent for the Activity.
  ...
  static async createDialog(data={}, { parent, types=null, ...options }={}) {
    ...
    const label = game.i18n.localize(`DOCUMENT.ROTV.${this.documentName}`);
