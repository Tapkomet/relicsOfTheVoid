...
export default class HitPointsAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      order: 10,
      icon: "systems/rotv/icons/svg/hit-points.svg",
      title: game.i18n.localize("ROTV.AdvancementHitPointsTitle"),
      hint: game.i18n.localize("ROTV.AdvancementHitPointsHint"),
      multiLevel: true,
      apps: {
  ...
  /** @inheritdoc */
  get levels() {
    return Array.fromRange(CONFIG.ROTV.maxLevel + 1).slice(1);
  }
  ...
  #getApplicableValue(value) {
    const abilityId = CONFIG.ROTV.defaultAbilities.hitPoints || "con";
