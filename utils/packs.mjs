 ...
 * base Relics system folder.
 * @type {string}
 */
const PACK_DEST = "packs";

/**
 * Folder where source JSON files should be located relative to the Relics system folder.
 * @type {string}
 */
...
function cleanPackEntry(data, { clearSourceId=true }={}) {
  ...
  if ( data._stats?.lastModifiedBy ) data._stats.lastModifiedBy = "rotvbuilder0000";
